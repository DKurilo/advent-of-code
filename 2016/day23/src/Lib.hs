...
data Op = CPY Arg Arg | INC Reg | DEC Reg | JNZ Arg Arg | TGL Reg deriving (Show)
...
part1Solution = getReg A . runProgram . setReg A 7 . mkProgram

part2Solution :: [Op] -> Int
part2Solution = getReg A . runProgram . setReg A 12 . mkProgram
